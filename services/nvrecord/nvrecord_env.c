...
static int nv_record_env_new(void)
{
	...
	nvrecord_env_p->stream_volume.a2dp_vol = NVRAM_ENV_STREAM_VOLUME_A2DP_VOL_DEFAULT;
	nvrecord_env_p->stream_volume.hfp_vol = NVRAM_ENV_STREAM_VOLUME_HFP_VOL_DEFAULT;
#ifdef __TWS__		
